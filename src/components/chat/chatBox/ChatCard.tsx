    ...
    return (
        <a href={url}>
            <ChatCardDiv shadow_drop="drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06))" border_radius="0.5rem" width="8rem" lg_width="13rem" min_height="100%" display="flex" flex_direction="column" background_color="white">
                ...
                <ChatCardBody grow="1" padding="0.5rem 0.75rem 0.75rem 75rem" lg_padding_left="1rem" lg_padding_right="1rem" background_color="rgb(14 165 233)" color="rgb(255 255 255)" rounded_r_lg="0.5rem" rounded_l_lg="0.5rem" display="flex" flex_direction="column" align_items="center">
                  <ChatCardContent width="100%" text_center="center" break_word="break-word" className="w-full break-words text-center">{title}</ChatCardContent>
